...
public class DatabaseHandler extends SQLiteOpenHelper {
   ...
   String CREATE_GESTURES_TABLE = "CREATE TABLE " + TABLE_GESTURES + "("
       ...
       + KEY_GEST + " TEXT," + KEY_USER +" TEXT," + KEY_PATTERN +" TEXT" + ")";
 ...
 void addGesture(Motiongesture gesture) {
      ...
      values.put(KEY_USER,gesture.getUser());
      values.put(KEY_PATTERN, gesture.getPattern());
   ...
   Motiongesture getGesture(int id) {
       ...
       KEY_NAME, KEY_GEST, KEY_USER,KEY_PATTERN }, KEY_ID + "=?",
...
// looping through all rows and adding to list
        ...
        do {
              ...
              gesture.setUser(cursor.getString(3));
              gesture.setPattern(cursor.getString(4));
